...
<Tabs defaultValue="java" className="pt-5 pb-1">
  <TabsList>
    <TabsTrigger value="java"><MyIcons.SourceCodeIcon className="h-4 w-4" />Code</TabsTrigger>
    <TabsTrigger value="typescript"><MyIcons.ScreenShareIcon className="h-4 w-4" />Preview</TabsTrigger>
  </TabsList>
