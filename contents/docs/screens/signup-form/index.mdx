...
keywords:
  [
    "react native profile creation form",
    "expo profile creation form",
    "react native signup form",
    "react native registration form",
    "react native user input form",
    "react native form validation",
    "floating label inputs react native",
    "animated form react native",
    "real time form validation react native",
    "password visibility toggle react native",
    ...
    "boilerplate signup form",
    "react native form example",
    "react native text input validation",
    "react native responsive form",
    "react native user onboarding form",
    "react native login form",
    "react native account creation",
  ]
author: "walid memon"
...
<DemoLinkButton href="https://www.nativemotion.dev/docs/components/floating-text-input"  size="lg" variant="default">
	Go To Component
</DemoLinkButton>
